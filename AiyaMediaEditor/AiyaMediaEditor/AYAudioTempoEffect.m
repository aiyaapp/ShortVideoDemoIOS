...
#import "AYAudioTempoEffect.h"
#import <AVFoundation/AVFoundation.h>

static const AVAudioFrameCount kFrameCount = 256;

@interface AYAudioTempoEffect ()
...
@implementation AYAudioTempoEffect
...
- (BOOL)renderAudioAndWriteToFile2{
    ...
    if (@available(iOS 11.0, *)) {
        ...
        // audio frame length
        NSUInteger lengthInFrames = (NSUInteger) (CMTimeGetSeconds(asset.duration) * audioDescription->mSampleRate / self.tempo);
