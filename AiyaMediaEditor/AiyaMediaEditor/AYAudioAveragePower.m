...
#import "AYAudioAveragePower.h"
#import <AVFoundation/AVFoundation.h>

@implementation AYAudioAveragePower
...
+ (NSArray *)averagePowerWithAudioURL:(NSURL *)url sampleCount:(NSUInteger)filteredSamplesCount{
    ...
    NSData *data = [AYAudioAveragePower pcmDataFromURL:url];
    ...
    for (NSUInteger i= 0; i < sampleCount - spanSize; i += spanSize){
        ...
        //选取样本数据中的平均值
        SInt16 value = [AYAudioAveragePower averageValueInArray:sampleBin ofSize:spanSize];
